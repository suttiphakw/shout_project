...
#         'id': _id
#     }
#     return render(request, 'shouters/register__info-2.html', context)
#
# def register_info_3(request, _id):
#     context = {
#         'id': _id
#     }
#     return render(request, 'shouters/register__info-3.html', context)
#
# def register_info_4(request, _id):
#     context = {
#         'id': _id
#     }
#     return render(request, 'shouters/register__info-4.html', context)
#
# def register_info_5(request, _id):
#     context = {
#         'id': _id
#     }
#     return render(request, 'shouters/register__info-5.html', context)
#
# def register_info_6(request, _id):
#     context = {
#         'id': _id
#     }
#     return render(request, 'shouters/register__info-6.html', context)
#
