...
urlpatterns = [
    ...
    path('register/info-2/<int:_id>/', views.register__info_2, name='regis-info-2'),
    path('register/info-3/<int:_id>/', views.register__info_3, name='regis-info-3'),
