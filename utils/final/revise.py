...
def sv_ig_fb(line_user_id, comment):
  response_1 = post(line_user_id=line_user_id)
  response_2 = post_comment(line_user_id=line_user_id, comment=comment)
