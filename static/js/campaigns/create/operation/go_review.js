...
function check_service_placel() {
  return $('#service_place').val() !== ''
}

function check_service_location() {
  return $('#service_location').val() !== ''
}

function check_service_payback() {
  return $('#service_payback').val() !== ''
}
...
$(document).ready(function(){
  $('.campaign__create__content').on('change', function() {
    ...
    if(check_operation_photo() && check_service_name() && check_service_detail() && check_service_location() && check_service_payback() && check_service_price() && check_shouter_post_date()) {
