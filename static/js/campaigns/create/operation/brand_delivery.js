...
function set_date() {
  ...
  const deliver_shouter_date = document.getElementById("deliver_shouter_date")
  const shouter_pickup_date = document.getElementById("shouter_pickup_date")
  ...
  deliver_shouter_date.removeAttribute("disabled")
  shouter_pickup_date.removeAttribute("disabled")
  ...
  autofill_date(shouter_post_date, deliver_shouter_date, 10);
  autofill_date(shouter_post_date, shouter_pickup_date, 8);
...
$(document).ready(function(){
  $('.campaign__create__content').on('change', function() {
    ...
    if(check_operation_photo() && check_service_name() && check_service_price() && check_shouter_post_date()) {
