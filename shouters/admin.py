...
class ShouterAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Personal Info', {'fields': ('nickname', 'first_name', 'last_name', 'email', 'tel', 'gender',
                                      ...
                                      'college', 'interest',)}),
        ('ID Card and BookBank', {'fields': ('id_card_photo', 'book_bank_photo', 'bank_name', 'bank_username', 'bank_account_number',)}),
        ...
        ('Instagram User Info', {'fields': ('ig_username', 'ig_media_count',
                                            'ig_follower_count', 'ig_following_count', 'ig_active_follower', 'ig_active_follower_percent',
                                            'ig_profile_picture', 'ig_profile_picture_file', 'ig_average_total_like', 'ig_engagement_percent',
        ...
        ('Work Selection', {'fields': ('is_check_ig', 'is_check_ig_story', 'is_check_ig_post', 'is_check_ig_story_post',
                                       'is_check_ig_fb', 'is_check_ig_fb_story', 'is_check_ig_fb_post',  'is_check_ig_fb_story_post',
                                       'is_check_tiktok', 'tiktok_name', 'tiktok_price', 'is_check_twitter', 'twitter_name', 'twitter_price')}),
        ('Line Token Info', {'fields': ('line_user_id', 'line_access_token', 'line_access_token_updated', 'line_id_token', 'line_id_token_updated')}),
